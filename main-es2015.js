...
function authReducer(state = initialAuthState, action) {
    switch (action.type) {
        case _actions_disqus_actions__WEBPACK_IMPORTED_MODULE_2__["AuthActionTypes"].LoadAuth:
            ...
            let auth = action.payload.authData;
...
const selectAuthData = (state) => state.AuthData.AuthData;
const selectAllUsers = (state) => state.AuthData.allUsers;
...
let LoginComponent = class LoginComponent {
    constructor(_router, store, service) {
